...
case class RawStats(data1: Data1 = Data1(), data2: Data2 = Data2(), // split fields into groups since play-json
                    data3: Data3 = Data3(), data4: Data4 = Data4()) // can't handle more than 22 fields
